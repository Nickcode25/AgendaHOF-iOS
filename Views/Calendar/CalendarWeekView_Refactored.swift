...
///              └─ ...
struct CalendarWeekView_Refactored: View {
...
#Preview("Week View") {
    struct PreviewWrapper: View {
        ...
        var body: some View {
            NavigationStack {
                CalendarWeekView_Refactored(viewModel: viewModel)
